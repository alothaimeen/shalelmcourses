...
$string['eligibility:addgroup'] = 'Add eligible batch';
$string['eligibility:addgroupfirst'] = 'Add an eligible batch before adding its graduation conditions.';
$string['eligibility:additem'] = 'Add graduation condition';
$string['eligibility:disable'] = 'Disable this batch';
$string['eligibility:disabled'] = 'Disabled — does not grant automatic admission';
$string['eligibility:emptygroup'] = 'This batch has no complete graduation conditions.';
$string['eligibility:enable'] = 'Enable this batch';
$string['eligibility:enabled'] = 'Enabled for automatic eligibility';
$string['eligibility:explanation'] = 'A student is admitted to a specialist pathway without a certificate when every condition in any enabled batch passes. Batch-one and batch-two graduation rules are independent from the batch-three and batch-four enrolment destinations; do not add the third batch level-one result here.';
$string['eligibility:gradeitem'] = 'Calculated completion result';
$string['eligibility:group'] = 'Eligible batch';
$string['eligibility:groupname'] = 'Eligible batch name';
$string['eligibility:invalidgroup'] = 'This batch cannot be enabled until all graduation conditions are complete and valid.';
$string['eligibility:mingrade'] = 'Minimum passing value';
$string['eligibility:nogroups'] = 'No specialist eligibility batches are configured.';
$string['eligibility:title'] = 'Automatic specialist eligibility';
...
$string['externalrequired'] = 'We did not find an approved foundation diploma graduation on this platform. If you hold an external Islamic qualification, upload it for review.';
...
$string['internaleligible'] = 'We verified your graduation from the foundation diploma on this platform. No certificate upload is required.';
...
$string['readiness:nocompletionsource'] = 'Specialist pathways are open, but the batch-one and batch-two graduation rules are incomplete or disabled.';
...
$string['task:reassesspending'] = 'Reassess pending applications from internal graduation results';
